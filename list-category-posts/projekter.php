...
foreach ($this->catlist->get_categories_posts() as $single):
    ...
    $lcp_display_output .= '<div class="ps-slider-anchor ps-anchor-'.$single->ID.'">'.$this->get_post_title($single).'</div><div class="ps-print-btn print-'.$single->ID.'"></div>';
     ...
     */
    $lcp_display_output .= $this->get_content($single, 'div', 'lcp_content content_'.$single->ID);
