<?php
/**
 * Template Name: Underside Kompetencer: OM- og tilbygning
 *
...
get_header(); ?>
	<div id="primary" class="site-content">
       ...
       <div class="sidebar-right">
        ...
        <?php if ( dynamic_sidebar('page_widget_om-tilbygning') ) : elseif ( dynamic_sidebar('page_widget_kompetencer') ) : elseif ( dynamic_sidebar('sidebar-1') ) : else  : endif; ?>
