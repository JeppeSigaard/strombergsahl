		...
		<div id="content" role="main">
            ...
            <div class="front-nyheder">
                <div class="front-nyheder-left">
                    ...
                    <div>
                        <ul>
                            <li class="news-<?php echo $news->ID ?>">
                                <a href="<?php echo get_the_permalink($news->ID); ?>" title="<?php echo get_the_title($news->ID); ?>"><?php echo get_the_title($news->ID); ?></a>  
                                <p><?php echo wp_trim_words(get_the_excerpt(),$num_words = 30, $more = null); ?></p>
                                <a class="news-more" href="<?php echo get_the_permalink($news->ID); ?>">Læs mere</a>
                            </li>
                            
                            <?php elseif ($news_num == 2) : ?>
                    ...
                    <div>
                        ...
                        <?php elseif ($news_num == 4) : ?>
                        
                            <li class="news-<?php echo $news->ID ?>">
                                <a href="<?php echo get_the_permalink($news->ID); ?>" title="<?php echo get_the_title(); ?>"><?php echo get_the_title($news->ID); ?></a>  
                                <p><?php echo wp_trim_words(get_the_excerpt(),$num_words = 30, $more = null); ?></p>
                                <a class="news-more" href="<?php echo get_the_permalink($news->ID); ?>">Læs mere</a>
                            </li>
                        </ul>
