<?php
/**
 * Template Name: Om os Underside - Job
 *
...
get_header(); ?>
	<div id="primary" class="site-content">
        ...
        <?php if ( dynamic_sidebar('page_widget_job') ) : elseif ( dynamic_sidebar('page_widget_about') )  : elseif ( dynamic_sidebar('sidebar-1') ) : else  : endif; ?>
