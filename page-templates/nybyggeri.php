<?php
/**
 * Template Name: Underside Kompetencer: Nybyggeri
 *
...
get_header(); ?>
	<div id="primary" class="site-content">
       ...
       <div class="sidebar-right">
        ...
        <?php if ( dynamic_sidebar('page_widget_nybyggeri') ) : elseif ( dynamic_sidebar('page_widget_kompetencer') ) : elseif ( dynamic_sidebar('sidebar-1') ) : else  : endif; ?>
